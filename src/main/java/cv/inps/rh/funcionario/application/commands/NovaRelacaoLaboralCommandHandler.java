...
@Component
public class NovaRelacaoLaboralCommandHandler implements CommandHandler<NovaRelacaoLaboralCommand, ResponseEntity<SuccessResponseDTO>> {
   ...
   @IgrpCommandHandler
   public ResponseEntity<SuccessResponseDTO> handle(NovaRelacaoLaboralCommand command) {
