...
public class ValidarDadosAcademicosService {
  ...
  public ValidarDadosAcademicosDTO executar(ValidarDadosAcademicosCommand command) {
    ...
    var dadosPessoaisReqDTO = dto.getDadosAcademicosProf();
    ...
    var habilitacoesLiterarias = habilitacaoLiterariaMapper.syncHabilitacoes(funcionario.getHabilitacoesLiterarias(), dadosPessoaisReqDTO.getHabilitacoesLiterarias());
    var formacoesFeitas = formacaoFeitaMapper.syncFormacoes(funcionario.getFormacoesFeitas(), dadosPessoaisReqDTO.getFormacoesFeitas());
    var experienciasProfissionais = experienciaProfissionalMapper.syncExperiencias(funcionario.getExperienciasProfissionais(), dadosPessoaisReqDTO.getExperienciasProfssionais());
