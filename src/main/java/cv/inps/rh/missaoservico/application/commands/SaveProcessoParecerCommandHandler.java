...
@Component
public class SaveProcessoParecerCommandHandler implements CommandHandler<SaveProcessoParecerCommand, ResponseEntity<Map<String, ?>>> {
   ...
   @IgrpCommandHandler
   public ResponseEntity<Map<String, ?>> handle(SaveProcessoParecerCommand command) {
