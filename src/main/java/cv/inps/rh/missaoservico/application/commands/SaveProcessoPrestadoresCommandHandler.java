...
@Component
public class SaveProcessoPrestadoresCommandHandler implements CommandHandler<SaveProcessoPrestadoresCommand, ResponseEntity<Map<String, ?>>> {
   ...
   @IgrpCommandHandler
   public ResponseEntity<Map<String, ?>> handle(SaveProcessoPrestadoresCommand command) {
