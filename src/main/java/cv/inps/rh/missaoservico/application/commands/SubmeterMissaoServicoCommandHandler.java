...
public class SubmeterMissaoServicoCommandHandler
      implements CommandHandler<SubmeterMissaoServicoCommand, ResponseEntity<MissaoSubmissaoGravadaResponseDTO>> {
   ...
   @IgrpCommandHandler
   public ResponseEntity<MissaoSubmissaoGravadaResponseDTO> handle(SubmeterMissaoServicoCommand command) {
