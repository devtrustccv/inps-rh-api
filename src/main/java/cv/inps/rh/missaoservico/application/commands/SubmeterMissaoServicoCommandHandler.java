...
import cv.inps.rh.missaoservico.application.services.MissaoServicoService;
...
public class SubmeterMissaoServicoCommandHandler
   ...
   private final MissaoServicoService missaoServicoService;

   public SubmeterMissaoServicoCommandHandler(MissaoServicoService missaoServicoService) {
