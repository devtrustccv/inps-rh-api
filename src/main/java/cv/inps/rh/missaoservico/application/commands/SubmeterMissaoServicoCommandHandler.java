...
@Component
public class SubmeterMissaoServicoCommandHandler implements CommandHandler<SubmeterMissaoServicoCommand, ResponseEntity<Map<String, ?>>> {

   private static final Logger LOGGER = LoggerFactory.getLogger(SubmeterMissaoServicoCommandHandler.class);

   public SubmeterMissaoServicoCommandHandler() {
