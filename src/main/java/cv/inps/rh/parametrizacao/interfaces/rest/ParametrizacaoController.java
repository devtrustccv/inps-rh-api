...
public class ParametrizacaoController {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = DominioDTO.class))
            ),
        }
    )
    ...
    @GetMapping(value = "cargos/ativos")
    @Operation(
    ...
    @GetMapping(value = "carreiras/ativos")
    @Operation(
    ...
    public ResponseEntity<List<ParametrizacaoDTO>> getCarreirasAtivos(
        @RequestParam(value = "pccsId", required = false) String pccsId
    ) {
        final var query = new GetCarreirasAtivosQuery(pccsId);

        return queryBus.handle(query);
    }

    @GetMapping(value = "categorias/ativos")
    @Operation(
    ...
    @GetMapping(value = "contratos/ativos")
    @Operation(
    ...
    @GetMapping(value = "escalao/ativos")
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = EscalaoDTO.class))
            ),
        }
    )
    ...
    @GetMapping(value = "local-trabalho/ativos")
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = LocalTrabalhoDTO.class)
                )
            ),
        }
    )
    public ResponseEntity<List<LocalTrabalhoDTO>> getLocalTrabalhoAtivos(
        ...
        final var query = new GetLocalTrabalhoAtivosQuery(paisId);

        return queryBus.handle(query);
    }

    @GetMapping(value = "vinculos/ativos")
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = VinculoDTO.class))
            ),
        }
    )
    ...
    @GetMapping(value = "seccoes/ativos")
    @Operation(
    ...
    public ResponseEntity<List<ParametrizacaoDTO>> getSeccoesAtivos(@RequestParam(value = "institId") Long institId) {
        final var query = new GetSeccoesAtivosQuery(institId);

        return queryBus.handle(query);
    }

    @GetMapping(value = "tipo-documento/ativos")
    @Operation(
    ...
    @GetMapping(value = "param-situacoes/motivos/ativos")
    @Operation(
    ...
    @GetMapping(value = "param-situacoes/ativos")
    @Operation(
    ...
    public ResponseEntity<List<ParametrizacaoDTO>> getParamSituacoesAtivo(
        ...
        final var query = new GetParamSituacoesAtivoQuery(
            flgSituacaoLaboral,
            flgAbonoBeneficio,
            flgAusencia,
            tipoAusencia,
    ...
    @GetMapping(value = "vinculos/situacoes-laborais/ativos")
    @Operation(
    ...
    public ResponseEntity<List<ParametrizacaoDTO>> getParamSituacoesLaboraisByVinculo(
        ...
        final var query = new GetParamSituacoesLaboraisByVinculoQuery(
            vinculoId,
            flgEstadoContrato,
            flgAbonoBeneficio,
            codigo
