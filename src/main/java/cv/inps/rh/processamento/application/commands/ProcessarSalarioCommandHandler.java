...
@Component
public class ProcessarSalarioCommandHandler implements CommandHandler<ProcessarSalarioCommand, ResponseEntity<String>> {
  ...
  @IgrpCommandHandler
  public ResponseEntity<String> handle(ProcessarSalarioCommand command) {
