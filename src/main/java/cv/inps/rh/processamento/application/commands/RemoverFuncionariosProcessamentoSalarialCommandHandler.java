...
import cv.inps.rh.processamento.domain.service.ProcessamentoSalarialService;
...
public class RemoverFuncionariosProcessamentoSalarialCommandHandler implements CommandHandler<RemoverFuncionariosProcessamentoSalarialCommand, ResponseEntity<String>> {
  ...
  private final ProcessamentoSalarialService processamentoSalarialService;

  public RemoverFuncionariosProcessamentoSalarialCommandHandler(ProcessamentoSalarialService processamentoSalarialService) {
