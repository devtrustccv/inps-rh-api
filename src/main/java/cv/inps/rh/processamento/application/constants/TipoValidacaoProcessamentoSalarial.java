...
public enum TipoValidacaoProcessamentoSalarial implements IgrpEnum<String> {
   ...
   */
  private static final Map<String, TipoValidacaoProcessamentoSalarial> CODE_MAP = Arrays.stream(values()).collect(
      Collectors.toMap(TipoValidacaoProcessamentoSalarial::getCode, Function.identity())
  );
  private final String code;
  private final String description;

  TipoValidacaoProcessamentoSalarial(String code, String description) {
    this.code = code;
   ...
   */
  public static Optional<TipoValidacaoProcessamentoSalarial> fromCode(String code) {
   ...
   */
  public static TipoValidacaoProcessamentoSalarial fromCodeOrThrow(String code) {
    return fromCode(code).orElseThrow(() ->
        IgrpResponseStatusException.of(
            HttpStatus.BAD_REQUEST,
            "Invalid TipoValidacaoProcessamentoSalarial for this code: " + code
        )
    );
  }
  ...
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values()
        ...
        .collect(
            Collectors.toMap(
                TipoValidacaoProcessamentoSalarial::getCode,
                TipoValidacaoProcessamentoSalarial::getDescription
            )
        );
  }
