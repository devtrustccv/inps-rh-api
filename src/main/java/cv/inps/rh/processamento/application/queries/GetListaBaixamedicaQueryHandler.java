...
@Component
public class GetListaBaixamedicaQueryHandler implements QueryHandler<GetListaBaixamedicaQuery, ResponseEntity<BaixaMedicaListDTO>> {
  ...
  @IgrpQueryHandler
  public ResponseEntity<BaixaMedicaListDTO> handle(GetListaBaixamedicaQuery query) {
