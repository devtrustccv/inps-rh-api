...
public class PesquisaService {
  ...
  public WrapperPesquisaCentroCustoDTO pesquisaCentroCusto(PesquisaColaboradorQuery query) {
    ...
    var page = tiposRelacionamentoEntityRepository.pesquisaCentroCusto(directionId, nome, pageRequest);
