...
public enum Domains implements IgrpEnum<String> {
  ...
  ABRANGENCIA_AVD("ABRANGENCIA_AVD", "ABRANGENCIA_AVD"),
  AVD_PONDERACAO_FINAL("AVD_PONDERACAO_FINAL", "AVD_PONDERACAO_FINAL"),
  NIVEIS_AVD("NIVEIS_AVD", "NIVEIS_AVD"),
  CLASSIFICACAO_QUALIT_AVD("CLASSIFICACAO_QUALIT_AVD", "CLASSIFICACAO_QUALIT_AVD");
