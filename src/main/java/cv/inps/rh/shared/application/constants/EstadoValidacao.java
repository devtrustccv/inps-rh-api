...
public enum EstadoValidacao implements IgrpEnum<String> {
  ...
  EstadoValidacao(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, EstadoValidacao> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(EstadoValidacao::getCode, Function.identity()));
  ...
  */
  public static Optional<EstadoValidacao> fromCode(String code) {
  ...
  */
  public static EstadoValidacao fromCodeOrThrow(String code) {
    return fromCode(code).orElseThrow(() -> IgrpResponseStatusException.of(HttpStatus.BAD_REQUEST, "Invalid EstadoValidacao for this code: " + code));
  }
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(EstadoValidacao::getCode, EstadoValidacao::getDescription));
  }
