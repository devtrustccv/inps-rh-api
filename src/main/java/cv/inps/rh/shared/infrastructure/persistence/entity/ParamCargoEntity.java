...
public class ParamCargoEntity extends AuditEntity {
    ...
    @Id
    @SequenceGenerator(name = "seq_param_cargo", sequenceName = "SEQ_PARAM_CARGO", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_param_cargo")
