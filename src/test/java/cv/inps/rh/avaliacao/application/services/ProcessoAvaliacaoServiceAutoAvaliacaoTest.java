...
public class ProcessoAvaliacaoServiceAutoAvaliacaoTest {
  ...
  @Test
  void gravarAutoAvaliacaoAtualizaAutoCamposERecalculaAvaliacao() {
    ...
    det.setPesoComportamentais(BigDecimal.valueOf(60));
    det.setPesoTecnica(BigDecimal.valueOf(40));
    ...
    assertEquals(new BigDecimal("1.26"), avaliacao.getAvaliacaoCompetencia());
